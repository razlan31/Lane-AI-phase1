  ...
  try {
    ...
    if (hasActiveSub) {
      ...
      const priceIdMapping = {
        [Deno.env.get("STRIPE_PRICE_ID_PRO_PROMO") || ""]: "pro",
        [Deno.env.get("STRIPE_PRICE_ID_PRO_STANDARD") || ""]: "pro", 
        [Deno.env.get("STRIPE_PRICE_ID_WEEKLY") || ""]: "pro",
        [Deno.env.get("STRIPE_PRICE_ID_ANNUAL") || ""]: "pro"
      };
      subscriptionTier = priceIdMapping[priceId] || "pro";
